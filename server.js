...
app.get('/ride-track', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'ride-track.html'));
});

app.get('/rental-book', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'rental-book.html'));
});

app.get('/parcel-book', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'parcel-book.html'));
});

app.get('/driver-onboarding', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'driver-onboarding.html'));
});
